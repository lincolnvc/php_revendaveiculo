    ...
    <body>
        ...
        <div class="container-fluid back">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Cadastrar Grupo</h4>
            </div>
        </div>
        <div class="content-wrapper">
            <div class="container">
                <form method="post" action="<?= Router::base(); ?>/grupo/gravar/">
                    <input type="hidden" name="grupo_id" class="form-control" value=""/>
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <input type="text" name="grupo_nome" id="grupo_nome" placeholder="Nome do Grupo"  class="form-control altura" required />
                        </div>
