    ...
    <body>
        ...
        <div class="container-fluid back">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Editar Slide</h4> 
            </div>
        </div>
        <div class="content-wrapper">
            <div class="container">
                <form method="post" enctype="multipart/form-data" action="<?php echo Router::base(); ?>/slide/atualizar/">
                    <input type="hidden" name="slide_id" id="slide_id" value="<?php echo $dados['slide']->slide_id; ?>"/>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="slide_nome">Título</label>
                            <input type="text" name="slide_nome"  placeholder="Informe o título do slide" required  class="form-control altura" 
                            ...
                            <?php if ($dados['slide']->slide_foto != ""): ?>
                                <p class="text-right">
                                    <img class="img-thumbnail" style="height:80px; "
                                         src="<?php echo Router::base(); ?>/midias/slide/<?php echo $dados['slide']->slide_foto; ?>" />
                                </p>    
                            <?php endif; ?>
                        </div>
                    </div>
