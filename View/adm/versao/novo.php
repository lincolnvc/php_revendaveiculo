    ...
    <body>
        ...
        <div class="container-fluid back">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Nova Versão</h4> 
            </div>
        </div>
        <!-- CONTEUDO AQUI -->
        <div class="content-wrapper">
            <div class="container">
                <form method="post" enctype="multipart/form-data" action="<?php echo Router::base(); ?>/versao/gravar/">
                    <input type="hidden" name="versao_id" id="versao_id" value="" />
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="versao_modelo" id="versao_modelo" class="form-control" required>
                                ...
                                <?php foreach ($dados['modelo'] as $p): ?>
                                    <option value="<?php echo $p->modelo_id ?>" data-conselho="<?php echo $p->marca_id; ?>"> <?php echo $p->modelo_nome ?></option>
                                <?php endforeach; ?>                           
                            </select>
                        </div>
                        <div class="form-group col-md-6">
