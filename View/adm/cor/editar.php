    ...
    <body>
        ...
        <div class="container-fluid back ">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Editar Cor</h4> 
            </div>                
        </div>
            ...
            <div class="container">
                <form method="post" action="<?= Router::base(); ?>/cor/gravar/">
                    <div class="form-group">
                        <input type="hidden" name="cor_id" class="form-control" value="<?= $dados[0]->cor_id; ?>"/>
                        <div class="row">
                            <div class="col-md-7  col-xs-12">
                                <input type="text" name="cor_nome" id="cor_nome" placeholder="Informe uma cor" class="form-control altura" required value="<?= $dados[0]->cor_nome; ?>"/>
                            </div>
