    ...
    <body>
        ...
        <div class="container-fluid back ">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Cadastrar Câmbio</h4>
            </div>
        </div>
        <div class="content-wrapper">
            <div class="container">
                <form method="post" action="<?= Router::base(); ?>/cambio/gravar/">
                    <input type="hidden" name="cambio_id" class="form-control" value=""/>
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <input type="text" name="cambio_nome" id="cambio_nome altura" placeholder="Nome do câmbio"  class="form-control altura" required />
                        </div>
                        <div class="col-md-6 col-xs-12">
