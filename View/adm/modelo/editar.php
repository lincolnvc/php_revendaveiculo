    ...
    <body>
        ...
        <div class="container-fluid back">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Editar Modelo</h4> 
            </div>
        </div>
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo Router::base(); ?>/modelo/incluir/">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="modelo_nome" id="modelo_nome" placeholder="Informe o Modelo" class="form-control" required 
                                   value="<?php echo $dados['modelo']->modelo_nome ?>" style="height: 35px"/>
                        </div>
                    </div><br/><br/>
                    <div class="row">    
        ...
        <script type="text/javascript">
            $(function () {
                $("#modelo_marca").val('<?php echo $dados['modelo']->modelo_marca ?>');
            });
            $("#modelo_marca").select2('val', '<?php echo $dados['modelo']->modelo_marca ?>');
        </script>
    </body>
</html>      