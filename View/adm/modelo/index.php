    ...
    <body>
        ...
        <div class="container-fluid back">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Modelo</h4>
            </div>
        </div>
        <!-- CONTEUDO AQUI -->
        <div class="content-wrapper">
            <div class="container">
                <p class="text-right">
                    <a href="<?php echo Router::base(); ?>/modelo/novo/" class="btn btn-primary"> 
                        <i class="fa fa-plus-circle"></i> 
                        Cadastrar Novo
                    </a>
                </p>
                <?php echo status::msg(); ?>
                <?php if (isset($dados['modelo'][0])): ?>
                    <table class="table table-striped table-bordered" id="tb1">
                        ...
                        <?php foreach ($dados['modelo'] as $obj) : ?>
                            <tr>
                                <td class="text-center"><img src="<?php echo Router::base(); ?>/midias/thumb.php?w=150&src=marca/<?php echo $obj->marca_foto; ?>" style="height: 100px" alt="logo da marca" class="img-responsive"/> </td>
                                <td class="text-uppercase hidden-xs" style="line-height: 100px"> <?php echo $obj->marca_nome; ?></td>
                                <td class="text-uppercase" style="line-height: 100px"> <?php echo $obj->modelo_nome; ?></td>
                                <td class="text-center" style="line-height: 100px"> 
                                    <a href="<?php echo Router::base(); ?>/modelo/editar/<?php echo $obj->modelo_id; ?>/"
                                       class="btn btn-primary btn-sm" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i>
                                    </a>
                                    <button data-link="<?php echo Router::base(); ?>/modelo/remover/<?php echo $obj->modelo_id; ?>/"
                                            class="btn btn-danger btn-sm btn-remover-modelo" data-toggle="tooltip" title="Remover"><i class="fa fa-trash"></i>
                                    </button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
        ...
        <div class="modal fade" id="modal-remove-modelo">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Você está prestes à remover um modelo e todos os automóveis relacionados à ela!</p>
                    </div>
        ...
        <script type="text/javascript">
            ...
            <?php endif; ?>
            $(function () {
                $("#menu-modelo").addClass('menu-top-active');
            ...
            $(function () {
                $('[data-toggle="tooltip"]').tooltip();
                $('.btn-remover-modelo').on('click', function () {
                    $('#modal-remove-modelo').modal('show');
