    ...
    <body>
        ...
        <div class="container-fluid back">
            <div class="container text-center">
                <h4 class="page-head-line titulo">Novo Parceiro</h4> 
            </div>
        </div>
        <div class="content-wrapper">
            <div class="container">
                <form method="post" enctype="multipart/form-data" action="<?php echo Router::base(); ?>/parceiro/incluir/">
                    <div class="row">
                        <div class="form-group col-md-6 col-xs-12">
                            <label for="slide_nome">Título</label>
                            <input type="text" name="slide_nome"  placeholder="Informe o nome do parceiro" class="form-control altura" required />
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-10">   
                            <span class="btn btn-black btn-file col-xs-12 col-md-4 ">
                                ...
                                Selecione um Logo<input type="file" id="perfil_foto" name="slide_foto" required>
                            </span>
                            &nbsp; &nbsp; &nbsp; 
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="hidden-xs text-right">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Cadastrar Dados</button>
                        </div>
                        <div class="visible-xs">
                            <br />
                            <button type="submit" class="btn btn-block btn-primary"><i class="fa fa-plus-circle"></i> Cadastrar Dados</button>
                            <br /><br />
                        </div>
                    </div>
                </form>
